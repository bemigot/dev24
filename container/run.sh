#!/usr/bin/env bash
# Build + run an Ubuntu 20.04 sandbox that exercises p24core's
# scripts/check-req.py as an UNPRIVILEGED user, with the checker code and a
...
#
# Defaults target the p24core checkout:
#   SCRIPTS = ~/e/p24core/scripts
#   PROJECT = ~/e/p24core            (i.e. ../ from scripts/)
#
